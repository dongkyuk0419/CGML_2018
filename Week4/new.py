...
class My_Model(object):
    ...
    def build_model(self):
        ...
        x = self.convconv(16,[7,7],2)(input)
        x = MaxPooling2D(3,strides = 2)(x)
        for i in range(0,4):
            x = self.residual_block(x,16)
        x = self.convconv(32,[3,3],2)(x)
        for i in range(0,3):
    ...
    def train(self):
        self.optim = optimizers.SGD(self.learning_rate,momentum=0.9,decay=0.0001)
        ...
        self.datagen = keras.preprocessing.image.ImageDataGenerator(
            ...
            zoom_range = 0.2, rotation_range = 50
            )
...
# I added more data augmentation features, and increased epochs to 512.